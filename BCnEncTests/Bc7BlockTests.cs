...
namespace BCnEncTests
{
	public class Bc7BlockTests
	{
		...
		private void Type4Pack(Span<Bc7Block> output) {
			...
			byte[] alphaEndPoints = new byte[]{
				0b111111,
				0
			};
			byte[] indices2Bit = new byte[] {
				0, 1, 2, 3,
				0, 1, 2, 3,
				3, 2, 1, 0,
				3, 2, 1, 0
		...
		public void PackTypes() {
			...
			FileStream fs = File.OpenWrite("bc7_blocktests.ktx");
			output.Write(fs);
		}
	}
}
